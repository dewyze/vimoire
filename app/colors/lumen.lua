...
hl(0, "VimoireActionButton", { fg = c.bg_lighter, bg = c.fg_dim, bold = true })
...
hl(0, "cssProp", { fg = c.fg_dim })
hl(0, "cssAttr", { fg = c.fg_dim })
hl(0, "cssClassName", { fg = c.header })
hl(0, "cssClassNameDot", { fg = c.header })
hl(0, "cssIdentifier", { fg = c.header })
hl(0, "cssTagName", { fg = c.section })
hl(0, "cssColor", { fg = c.fg_dim })
hl(0, "cssValueLength", { fg = c.fg_dim })
hl(0, "cssValueNumber", { fg = c.fg_dim })
