...
describe("Entry", function()
  ...
  describe("chapter", function()
    it("holds chapter metadata", function()
      local chapter = Item.new("chapter", { id = "ch1", kind = "chapter", name = "Test" }, "/root")
    ...
    it("returns text_path", function()
      local chapter = Item.new("chapter", { id = "abc123", kind = "chapter", name = "Test" }, "/some/root")
  ...
  describe("mutations", function()
    ...
    describe("create chapter", function()
      it("creates a new chapter in section", function()
        local section_data = state.manuscript.items[1]

        local chapter = Item.create("chapter", state, "New Chapter", section_data.items, #section_data.items + 1)
      ...
      it("creates a new chapter at root level", function()
        local chapter = Item.create("chapter", state, "Root Chapter", state.manuscript.items, #state.manuscript.items + 1)
